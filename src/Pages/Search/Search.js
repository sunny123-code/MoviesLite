      ...
      <ThemeProvider theme={DarkTheme}>
        ...
        <div className='TextField'>
          ...
          <TextField
            ...
            inputProps={{ style: { fontWeight: "bold", color: "white" } }}
            InputLabelProps={{ style: { fontSize: 15, fontWeight: "bold", color: "white" } }}
        ...
        <div className='searchType'>
          ...
          >
          <Tab  sx={{fontWeight:"bold", width:"50%"}} label="Search Movie"  />
          <Tab sx={{fontWeight:"bold", width:"50%"}}  label="Search TV Series" />
